...
pub const VERIFIED_CLAUDE_VERSION: &str = "2.1.224";
...
mod tests {
    ...
    fn the_verified_release_says_nothing() {
        ...
        assert_eq!(classify("2.1.224", VERIFIED_CLAUDE_VERSION), VersionVerdict::Verified);
        assert!(drift_notice("claude", "2.1.224", VERIFIED_CLAUDE_VERSION).is_none());
    }
